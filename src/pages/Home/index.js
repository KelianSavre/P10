...
const Page = () => {
  const { data } = useData();
  // Data n'est pas nul contrairement a last parce que ca correspond au format de DataContext par rapport a useContext? a verifier
  

  // Last fonctionne quand data est deja defini mais ne fonctionne pas au chargement de page avec le code precedent en essayant diverses condition le chargement s'est effectue mais il va falloir comprendre pourquoi ca ne marchait pas et pourquoi l'erreur console persiste
